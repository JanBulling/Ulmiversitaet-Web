...
author: Stefan Rau
keywords: MFA, kiz
description: Die Multi-Faktor-Authentifizierung (MFA) ist eine wichtige Sicherheitsmaßnahme des kiz (Kommunikations- und Informationszentrums). Sie schützt den Zugang zu sensiblen Diensten wie dem VPN oder dem Identitätsmanagement durch einen zusätzlichen Sicherheitsfaktor.
---
...
- ✅ **VPN-Zugang** der Universität [(Hier geht's zur Anleitung)](https://www.ulmiversitaet.de/guides/vpn)
...
2. **Neuen Token erstellen:**  
   ...
   - Erstelle unter _MFA-Verwaltung_ einen **neuen Software-Token**
