        ...
        <div className="space-y-8">
            ...
            {started && !showResult && (
                <div className="space-y-6">
                    ...
                    <div className="flex gap-3">
                        <Button onClick={handleJa} variant="default">Ja</Button>
                        <Button onClick={handleNein} variant="secondary">Nein</Button>
                    </div>
                </div>
            )}
            ...
            {showResult && (
                <div className="space-y-6 pt-6">
                    <div className="flex flex-col items-center justify-center text-center py-16 min-h-[12rem] gap-2">
                    ...
                    <div className="flex justify-center pt-2">
                        <Button variant="outline" onClick={handleShare} disabled={hasCopied}>
